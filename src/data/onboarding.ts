export const consentContent = {
  ...
  paragraphs: [
    ...
    },
    {
      ...
      body: [
        "본 연구는 학술 연구 목적으로만 수행되며, 수집된 자료는 연구 목적 외의 용도로 사용되지 않습니다. 본 연구에서는 연령대, 성별 및 설문 응답을 수집하며, 연구자료는 참가자 코드로 관리됩니다.",
        "본 실험 완료 보상인 모바일 상품권을 지급하기 위해 휴대전화 번호를 수집합니다. 수집된 휴대전화 번호는 연구자료와 구분하여 보관하며, 연구진만 접근할 수 있는 안전한 공간에서 관리됩니다. 휴대전화 번호는 상품권 지급 목적으로만 사용하고, 지급 완료 후 즉시 폐기합니다. 다만 사후 인터뷰 참여 의향을 밝힌 경우에는 인터뷰 대상자 선정 및 일정 안내, 인터뷰 보상 지급을 위해서도 사용하며, 관련 절차가 완료된 후 즉시 폐기합니다. 이름과 주민등록번호 등 그 밖의 개인정보 및 민감정보는 수집하지 않습니다.",
        "수집된 연구자료는 연구 분석, 학술 발표 및 논문 작성에 활용될 수 있으며, 연구 결과는 개인을 식별할 수 없는 형태로만 보고됩니다. 연구자료는 연구 종료 후 3년 동안 안전하게 보관한 뒤 복구할 수 없는 방법으로 폐기합니다.",
      ],
    },
    {
      heading: "예상되는 위험",
