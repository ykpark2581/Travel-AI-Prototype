  ...
  paragraphs: [
    ...
    },
    {
      ...
      body: [
        ...
        "· 연구 1 파일럿 연구 또는 연구 2 본실험에 이미 참여한 사람",
        "· 연구 참여에 동의하지 않은 사람",
        "귀하는 본 설명문을 확인하기에 앞서 연령, 인터넷에 연결된 PC 이용 가능 여부 및 대화형 생성형 AI 서비스 사용 경험을 확인하는 총 3개의 스크리닝 문항에 응답하였습니다. 스크리닝 결과 위 선정기준을 모두 충족한 경우에만 본 설명문과 동의 항목이 제시됩니다. 스크리닝 기준 중 하나라도 충족하지 않은 경우에는 연구 참여 대상에 해당하지 않는다는 안내와 함께 설문이 종료되며, 이후 설명문, 동의 항목, 사전설문 및 AI 여행 플래너는 제시되지 않습니다.",
        ...
        "3. 조건별 사후 설문: 각 여행 계획 과업이 끝날 때마다 방금 경험한 여행 계획 방식에 관한 9문항에 응답합니다. 총 3회 진행되며, 약 6분이 소요됩니다.",
        "4. 최종 설문: 세 가지 방식을 모두 경험한 후 가장 만족스러웠던 방식과 그 이유에 관한 2문항에 응답합니다. 약 5분이 소요됩니다.",
        "5. 보상 및 심층면담 참여 의향 확인: 참여 보상 지급을 위한 휴대전화번호를 입력하고, 심층면담 참여 의향을 확인합니다. 약 1분이 소요됩니다.",
    ...
    },
    {
      ...
      body: [
        ...
        "다만 사후 심층 인터뷰 참여 의향을 밝힌 경우에는 해당 휴대전화 번호를 인터뷰 대상자 선정 및 일정 안내를 위해서도 사용합니다. 인터뷰 대상자로 선정되어 인터뷰를 완료한 참가자에게는 5,000원 상당의 커피 모바일 상품권을 추가로 지급하며, 연락과 보상 지급이 모두 완료된 후 휴대전화 번호를 즉시 폐기합니다.",
